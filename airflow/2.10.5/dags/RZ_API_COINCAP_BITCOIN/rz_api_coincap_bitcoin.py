...
def gerar_sql_insert_coincap(**context):
    ...
    url = "https://api.coincap.io/v2/assets/bitcoin/history?interval=h1&limit=2000"
...
with DAG(
    dag_id="rz_api_coincap_bitcoin",
    description="Carrega dados da CoinCap Assets sobre Bitcoin direto pro BigQuery",
    default_args=default_args,
    schedule_interval="20 * * * *",
    catchup=False,
    tags=["coincap", "bigquery", "etl", "assets", "bitcoin", "rz"],
) as dag:
    ...
    acionar_dag_sz = TriggerDagRunOperator(
        ...
        trigger_dag_id="sz_api_coincap_bitcoin",
